...
При выполнении лаболаторной №7, мною небыло замечено кода который выдаст мне вариант для самостоятельной работы, поэтому я использую вариант №20 из лаболаторной №6. Возвращаю операнд к функции в программе и изменяю ее так, чтобы она выводила переменную с наименьшим значением (рис. -@fig:013).
